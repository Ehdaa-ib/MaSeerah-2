...
/// Placeholder: reorder [parts] to match [correctOrder].
///
/// TODO: Connect to landmark page; haptic feedback; scoring.
class ReorderChallengeWidget extends StatefulWidget {
  const ReorderChallengeWidget({super.key, required this.stage});

  final ChallengeStageModel stage;

  @override
  State<ReorderChallengeWidget> createState() => _ReorderChallengeWidgetState();
}

class _ReorderChallengeWidgetState extends State<ReorderChallengeWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Reorder', style: ChallengeStyles.titleStyle),
